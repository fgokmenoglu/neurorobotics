...
public class SliderApplication extends RoboticsAPIApplication {
    ...
    public void initialize() {
        ...
        try {
            ...
            String dynamicLogFileName = "C:/KRC/Roboter/log/neurorobotic/SliderData_" + timeStamp + ".csv";
            ...
            fileLogger.println("Timestamp_EndEffector-X_EndEffector-Y_EndEffector-Z_J1-Pos-rad_J2-Pos-rad_J3-Pos-rad_J4-Pos-rad_J5-Pos-rad_J6-Pos-rad_J7-Pos-rad_J1-Torque-Nm_J2-Torque-Nm_J3-Torque-Nm_J4-Torque-Nm_J5-Torque-Nm_J6-Torque-Nm_J7-Torque-Nm");
    ...
    public void run() {
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            if (fileLogger != null) {
                ...
                String csvLine = String.format("%d_%.2f_%.2f_%.2f_%.4f_%.4f_%.4f_%.4f_%.4f_%.4f_%.4f_%.4f_%.4f_%.4f_%.4f_%.4f_%.4f_%.4f", System.currentTimeMillis(), currentFrame.getX(), currentFrame.getY(), currentFrame.getZ(), jointPos[0], jointPos[1], jointPos[2], jointPos[3], jointPos[4], jointPos[5], jointPos[6], torqueVals[0], torqueVals[1], torqueVals[2], torqueVals[3], torqueVals[4], torqueVals[5], torqueVals[6]);
